...
namespace Serilog.Sinks.Amazon.Kinesis.Firehose
{
    ...
    // Important not to dispose this StreamReader as the stream must remain open.
        ...
        protected static bool TryReadLine(Stream current, ref long nextStart, out string nextLine)
        {
    ...
    // Important not to dispose this StreamReader as the stream must remain open.
        ...
        protected static void TryReadBookmark(Stream bookmark, out long nextLineBeginsAtOffset, out string currentFile)
        {
